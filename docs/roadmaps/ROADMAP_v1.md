...
- **F002 프로젝트 상세 조회**: 설명(Notion 본문), 기술스택, GitHub/데모 링크, 기간을 상세 페이지에 표시 (프로젝트 상세)
...
- **Task 004: 홈/목록/상세 페이지 UI 완성 (더미 데이터)** ✅ - 완료 (See: /tasks/004-home-list-detail-pages-ui.md)
  ...
  - 프로젝트 상세: 제목, 기간, 기술스택, 본문 영역, GitHub/데모 버튼 (데모 링크 없으면 버튼 숨김, 새 탭 + `rel="noopener noreferrer"`) — 썸네일은 카드/그리드 전용, 상세 페이지에는 미노출
...
- **Task 008: F003 홈 대표 프로젝트 하이라이트 연동** ✅ - 완료 (See: /tasks/008-f003-featured-projects-highlight.md)
...
- **Task 012: Vercel 배포 및 운영 구성** ✅ - 완료
  ...
  - 프로덕션 스모크 테스트 체크리스트를 README에 작성(홈/목록/상세, 외부 링크 새 탭, 라이트·다크모드, 모바일 뷰포트) — shrimp Task012-3 완료
  - 실제 Vercel 프로젝트 연결·환경변수 입력·배포 완료 (사용자 직접 수행)
